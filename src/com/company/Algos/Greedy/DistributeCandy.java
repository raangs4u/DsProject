...
public class DistributeCandy {
    ...
    public static int candy1(List<Integer> r) {
        int n = r.size();
        int[] left = new int[n];
        int[] right = new int[n];
        for (int i = 0; i <n ; i++) {
